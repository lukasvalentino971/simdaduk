...
if (isset($_POST['Ubah'])) {
	$sql_ubahPengguna = "UPDATE pengguna SET nama_pengguna ='" . $_POST['nama'] . "' WHERE id_pend='" . $_POST['id_pend'] . "'";
	...
	$query_ubah = mysqli_query($koneksi, $sql_ubahPengguna);
	mysqli_close($koneksi);

	if ($query_ubah && $sql_ubahPengguna) {
		echo "<script>
